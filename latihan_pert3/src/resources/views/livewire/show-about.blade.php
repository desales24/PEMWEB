                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{ asset ('front/images/couple-working-from-home-together-sofa.jpg') }}" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    ...
                                    <img src="{{ asset ('front/images/happy-bearded-young-man.jpg') }}" class="avatar-image img-fluid" alt="">
                                </div>
