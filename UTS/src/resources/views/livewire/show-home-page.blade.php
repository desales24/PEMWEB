            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="section-title pt-4">
                        <p class="text-primary text-uppercase fw-bold mb-3">Aplikasi Data Mahasiswa</p>
                        <h1>Fitur Layanan Kami</h1>
                        <p>Aplikasi ini menyediakan berbagai fitur untuk pengelolaan data mahasiswa dengan mudah dan efisien.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" href="student-registration.html">
                        <div class="block">
                            <span class="colored-box text-center h3 mb-4">01</span>
                            <h3 class="mb-3 service-title">Pendaftaran Mahasiswa</h3>
                            <p class="mb-0 service-description">Fitur untuk menambahkan data mahasiswa baru ke dalam sistem.</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" href="student-records.html">
                        <div class="block">
                            <span class="colored-box text-center h3 mb-4">02</span>
                            <h3 class="mb-3 service-title">Data Mahasiswa</h3>
                            <p class="mb-0 service-description">Lihat dan kelola data mahasiswa yang sudah terdaftar.</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" href="student-grades.html">
                        <div class="block">
                            <span class="colored-box text-center h3 mb-4">03</span>
                            <h3 class="mb-3 service-title">Manajemen Nilai</h3>
                            <p class="mb-0 service-description">Catat dan kelola nilai mahasiswa dengan mudah.</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" href="student-attendance.html">
                        <div class="block">
                            <span class="colored-box text-center h3 mb-4">04</span>
                            <h3 class="mb-3 service-title">Pendaftaran</h3>
                            <p class="mb-0 service-description">Mengajukan Pendaftaran</p>
                        </div>
                    </a>
                </div>
            </div>
